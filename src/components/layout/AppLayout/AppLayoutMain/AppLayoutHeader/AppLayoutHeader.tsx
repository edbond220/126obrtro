...
const AppLayoutHeader = ({}: AppLayoutHeaderProps) => {
  ...
  return (
    <header className="app-layout-header bg-white fixed left-0 top-0 flex justify-center w-full">
      <div className="flex max-w-lg flex py-4 px-8 w-full justify-between align-center">
